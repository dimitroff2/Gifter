...
namespace Gifter.Repositories
{
    public class PostRepository : BaseRepository, IPostRepository
        //To create interface make sure to right click on parent repository then quick actions to extract interface
    {
        //get posts is set now to get both the post and user profile information at the same time so there are less round trips
...
//Remember that cannot generate interface if there are errors in the build
